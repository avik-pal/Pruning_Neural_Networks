...
for k in [0, 25, 50, 60, 70, 80, 90, 95, 97, 99]:
    ...
    test_acc_file_0 = "./logfiles/test_acc_k_{}_strategy_0".format(k)
    test_acc_file_1 = "./logfiles/test_acc_k_{}_strategy_1".format(k)
    log_file_0 = "./logfiles/logs_{}_0.txt".format(k)
    log_file_1 = "./logfiles/logs_{}_1.txt".format(k)
